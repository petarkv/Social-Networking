    ...
    <div style="padding:20px 15px 30px 15px;">
            ...
            <form id="photosForm" name="photosForm" action="{{ url('/step/3') }}" method="post" enctype="multipart/form-data">
                ...
                <table width="80%" cellpadding="10" cellspacing="10">
                    <tr>
                        ...
                        <td align="left" valign="top"><input autocomplete="off" id="photo" name="photo[]" 
                            type="file" multiple="multiple" style="width:220px; font-size: 14px" /></td>
                    </tr>
                    <tr>
                        <td></td>
        ...
        <div class="recent_add_prifile">
            ...
            @foreach($user_photos as $photo)
              <div class="profile_box first"> <span class="photo"><img src="/images/frontend_images/photos/{{ $photo->photo }}" 
                alt="" /></span>
              ...
              <tr><td>
                <a <?php /* href="/delete-photo/{{ $photo->photo }}" */ ?> rel="{{ $photo->photo }}" rel1="delete-photo"  
                    href="javascript:" class="deleteAction"><button type="button" class="btn btn-danger">Delete</button></a> 
              </td><td>
                @if($photo->default_photo != "Yes")
