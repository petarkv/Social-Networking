          ...
          <div> <br />
            ...
            <form id="signupForm" action="{{ url('/register') }}" method="post">{{ csrf_field() }}
              <table width="80%">
                ...
                <tr>
                    <td align="left" valign="top" class="body"><strong>Surname:</strong></td>
                    <td align="left" valign="top"><input id="surname" name="surname" type="text" size="22" /></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td align="left" valign="top"><input id="user_password" name="password" type="password" size="22" />
