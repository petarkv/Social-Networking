...
<head>
        <title>Admin Panel | Dating</title><meta charset="UTF-8" />
    ...
    <body>
        ...
        <form id="loginform" class="form-vertical" method="POST" action="{{ url('admin') }}">{{ csrf_field() }}
                 <div class="control-group normal_text"> <h3><img src="{{ asset('images/backend_images/logo_dating.png') }}" alt="Logo" /></h3></div>
