...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="{{ url('/admin/dashboard') }}" title="Go to Home" class="tip-bottom">
            <i class="icon-home"></i> Home</a> <a href="{{ url('/admin/view-users') }}" class="current">Users</a> 
        </div>
        <h1>Users</h1>
    </div>
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td>
                                        @if(!empty($user['details']['id']))
                                            ...
                                            <div id="myModal{{ $user['id'] }}" class="modal hide">
                                                <div class="modal-header">
                                                    ...
                                                    <h3>User Details</h3>
                                                    <input class="userStatus" rel="{{ $user['id'] }}" type="checkbox" data-toggle="toggle"  
                                                        data-on="Enabled" data-off="Disabled" @if($user['details']['status']=="1") checked @endif>
                                                </div>
                                        ...
                                        @if(!empty($user['photos'][0]['photo']))
                                            <a href="#myPhotos{{ $user['id'] }}" data-toggle="modal" 
                                                class="btn btn-success btn-mini">View Photos</a>
                                                                    ...
                                                                    <table>
                                                                        <tr>
                                                                            ...
                                                                            <td width="60%" align="left" valign="top">
                                                                                <input class="userPhotoStatus" rel="{{ $photo['id'] }}" type="checkbox" data-toggle="toggle"  
                                                                                data-on="Enabled" data-off="Disabled" @if($photo['status']=="1") checked @endif>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
